...
<div class="pc_sign_in_box">
    ...
    <div class="pc_sign_in_cont">
        ...
        <div id="result">请使用微信扫描二维码登录“卖家管理系统”</div>
    </div>
...
<script type="text/javascript">
    ...
    !function(){
        var uuid = $("#uuid").val();
        console.log(uuid);
        var content =  "http://"+"${pageContext.request.serverName}"+":"+"${pageContext.request.serverPort}"+"/sell/seller/scanLogin?uuid="+uuid;
    ...
    function keepPool(){
        ...
        $.get("/sell/seller/pool",{uuid:uuid,},function(msg){//如果放入一个不存在的网址怎么办?
            if(msg.successFlag == '1'){
                console.log("扫码成功.....")
                $("#result").html("<font color='#583e7e'>扫码成功</font>");
